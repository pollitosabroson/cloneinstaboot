...
def test():
    bot = InstaBot(
        ...
        tag_list=[
            'follow4follow', 'f4f', 'primerolacomunidad', 'ilovepiques',
            'exklusive_shot', 'shotawars', 'descobreixcatalunya',
            'ig_catalonia', 'ig_europe', 'ig_barcelona', 'ig_clubaward',
            'ig_worldclub', 'ig_photooftheday', 'vsco', 'vscocam',
            'fotonline_es', 'igersmaresme', 'thebarcelonist', 'igersspain',
            'unlimitedbarcelona', 'fotomovil_es', 'catalunyagrafias',
            'ok_catalunya', 'canonespaña', 'AGameofTones', 'PortraitGames',
            'artofvisuals', 'catalunyaexperience', 'MoodyGrams',
            'street_focus_on', 'raconsde_catalunya', 'Zacatecas', 'México',
            'España', 'España', 'Espanya', 'cataluña', 'catalunya', 'Terrassa',
            'FatalFrames', 'street_focus_on', 'artofcisuals', 'MoodyGrams'],
        tag_blacklist=['rain', 'thunderstorm'],
        user_blacklist={
            'cube.miami': '', 'josep_batet': '', 'avq_68': '', 'rcaneter': '',
            'sergitugas': ''
        },
        max_like_for_one_tag=32,
        follow_per_day=1000,
        follow_time=4 * 60 * 60,
        unfollow_per_day=0,
